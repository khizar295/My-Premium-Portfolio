...
import { FaExternalLinkAlt, FaShieldAlt, FaSpinner, FaCheckCircle, FaEnvelope } from "react-icons/fa";
...
export default function Project9() {
  ...
  const slides = [
    { id: 1, title: "Dark Mode Preview", img: img1 },
    { id: 2, title: "Light Mode Preview", img: img2 },
  ];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                ...
                <span className="text-xs font-medium text-stone-600">Email Marketing</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Email Template <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Design</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A responsive email template designed to work seamlessly across all email clients, 
                featuring both dark and light mode support. This template showcases modern email 
                design principles with clean layouts, optimized images, and compatibility with 
                major email platforms like Gmail, Outlook, and Apple Mail.
              </p>
