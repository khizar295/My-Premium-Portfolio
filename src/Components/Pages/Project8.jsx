...
import { FaExternalLinkAlt, FaShieldAlt, FaSpinner, FaCheckCircle, FaDatabase } from "react-icons/fa";
import img1 from "../../assets/slider-proj-8-1.png";
import img2 from "../../assets/slider-proj-8-2.png";

export default function Project8() {
  const redirectUrl = "https://offline-handling-of-apis.vercel.app/";
  ...
  const slides = [
    { id: 1, title: "Offline Data View", img: img1 },
    { id: 2, title: "Local Storage", img: img2 },
  ];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <FaDatabase className="text-amber-600 text-xs" />
                <span className="text-xs font-medium text-stone-600">Offline-First Approach</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Offline API <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Handling</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A powerful demonstration of offline API handling using Arrays and Local Storage. 
                This project showcases how to cache API responses, manage offline data persistence, 
                and provide a seamless user experience even without an internet connection. Built 
                with React.js for robust state management.
              </p>
