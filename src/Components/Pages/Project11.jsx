...
import { FaExternalLinkAlt, FaShieldAlt, FaSpinner, FaCheckCircle, FaSun, FaMoon } from "react-icons/fa";
...
export default function Project11() {
  ...
  const slides = [
    { id: 1, title: "Day Mode - Bright", img: img1 },
    { id: 2, title: "Night Mode - Dark", img: img2 },
    { id: 3, title: "Toggle Animation", img: img3 },
    { id: 4, title: "Interactive UI", img: img4 },
    { id: 5, title: "Smooth Transition", img: img5 },
  ];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                ...
                <span className="text-xs font-medium text-stone-600">Theme Switcher</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Color Switching <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Toggle</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                An interactive color switching toggle that transforms the interface from day to night 
                mode with smooth animations. This project demonstrates modern front-end techniques 
                for theme switching, featuring glowing effects, smooth transitions, and a delightful 
                user experience.
              </p>
