...
import { FaExternalLinkAlt, FaShieldAlt, FaSpinner, FaCheckCircle, FaLayerGroup } from "react-icons/fa";
import img1 from "../../assets/slider-proj-12-1.png";

export default function Project12() {
  const redirectUrl = "https://show-cards-by-routing.vercel.app/";
  ...
  const slides = [{ id: 1, title: "Card Navigation Preview", img: img1 }];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <FaLayerGroup className="text-amber-600 text-xs" />
                <span className="text-xs font-medium text-stone-600">Navigation System</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Card Routing <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">System</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A dynamic card routing system that allows navigation between pages with previous 
                and next buttons. Built with React.js, this project demonstrates efficient routing, 
                pagination, and state management. Users can browse through cards with intuitive 
                controls for a seamless browsing experience.
              </p>
