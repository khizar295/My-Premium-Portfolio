...
import { FaExternalLinkAlt, FaShieldAlt, FaSpinner, FaCheckCircle, FaRegCommentDots } from "react-icons/fa";
import img1 from "../../assets/slider-proj-10-1.png";

export default function Project10() {
  const redirectUrl = "https://contact-form-lime-one.vercel.app/";
  ...
  const slides = [{ id: 1, title: "Contact Form Preview", img: img1 }];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <FaRegCommentDots className="text-amber-600 text-xs" />
                <span className="text-xs font-medium text-stone-600">User Engagement</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Contact Form <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Solution</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A beautifully designed contact form built with HTML and CSS, featuring essential 
                fields for user inquiries. This form includes validation, responsive layout, and 
                modern styling to provide a seamless user experience. Perfect for websites needing 
                a professional way to connect with visitors.
              </p>
