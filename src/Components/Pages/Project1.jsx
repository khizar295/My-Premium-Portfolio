...
import img1 from "../../assets/slider-proj-1-1.png";
import img2 from "../../assets/slider-proj-1-2.png";
import img3 from "../../assets/slider-proj-1-3.png";
import img4 from "../../assets/slider-proj-1-4.png";
import img5 from "../../assets/slider-proj-1-5.png";
import img6 from "../../assets/slider-proj-1-6.png";
import img7 from "../../assets/slider-proj-1-7.png";
import img8 from "../../assets/slider-proj-1-8.png";
import img9 from "../../assets/slider-proj-1-9.png";
import img10 from "../../assets/slider-proj-1-10.png";

export default function Project1() {
  const redirectUrl = "https://khizar-rehman-portfolio.vercel.app/";
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <span className="text-xs font-medium text-stone-600">Featured Project</span>
              </div>
              ...
              <p className="text-stone-600 leading-relaxed mb-6">
                This project demonstrates an elegant integration of UX design patterns and modern 
                front-end techniques. It focuses on accessibility, smooth micro-interactions, and 
                an engaging content flow. Explore the demo using the verification control below — 
                once verified you can learn more about the project and be redirected to a live demo.
              </p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              ...
              <div className="relative bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl overflow-hidden">
                ...
                <div
                  ref={sliderRef}
                  className="flex gap-4 py-6 px-4 overflow-hidden"
          ...
          <div className="relative max-w-md w-full bg-white rounded-2xl p-6 shadow-2xl animate-fadeInUp">
            <div className="text-center mb-4">
              ...
              <p className="text-stone-600">
                You will be redirected in <span className="font-semibold text-amber-600">{countdown}</span> second{countdown !== 1 && "s"}
              </p>
            </div>
            <div className="flex justify-center gap-3 mt-4">
              <button onClick={() => setModalOpen(false)} className="px-5 py-2 rounded-full border border-stone-200 text-stone-600 hover:bg-stone-50 transition-colors">
                Close
              </button>
              <button onClick={() => (window.location.href = redirectUrl)} className="px-5 py-2 rounded-full bg-gradient-to-r from-amber-500 to-rose-500 text-white font-medium hover:shadow-md transition-all">
                Go Now
              </button>
            </div>
          </div>
