          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <span className="text-xs font-medium text-stone-600">Video Downloader Tool</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Social Video <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Downloader</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A powerful tool that allows you to download videos from Facebook, Instagram, TikTok, 
                and YouTube by simply pasting the link. Built with React.js and modern web technologies 
