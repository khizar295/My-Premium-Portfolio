    ...
    <div className="w-full p-6 mt-30 md:mt-45 lg:mt-25">
      ...
      <div className="flex flex-wrap gap-6 border-b pb-3">
        {tabs.map((tab, index) => (
          <button
            key={index}
            onClick={() => { setActiveTab(index); setShowFull(false); }}
