...
import { FaExternalLinkAlt, FaShieldAlt, FaSpinner, FaCheckCircle, FaShoppingCart } from "react-icons/fa";
import img1 from "../../assets/slider-proj-6-1.png";
import img2 from "../../assets/slider-proj-6-2.png";
import img3 from "../../assets/slider-proj-6-3.png";
import img4 from "../../assets/slider-proj-6-4.png";
import img5 from "../../assets/slider-proj-6-5.png";
import img6 from "../../assets/slider-proj-6-6.png";
import img7 from "../../assets/slider-proj-6-7.png";
import img8 from "../../assets/slider-proj-6-8.png";
import img9 from "../../assets/slider-proj-6-9.png";

export default function Project6() {
  const redirectUrl = "https://e-shopping-store-phi.vercel.app/";
  ...
  const slides = [
    { id: 1, title: "Product Listing", img: img1 },
    { id: 2, title: "Shopping Cart", img: img2 },
    { id: 3, title: "Checkout", img: img3 },
    { id: 4, title: "Product Details", img: img4 },
    { id: 5, title: "User Dashboard", img: img5 },
    { id: 6, title: "Order Summary", img: img6 },
    { id: 7, title: "Payment", img: img7 },
    { id: 8, title: "Mobile View", img: img8 },
    { id: 9, title: "Category Filter", img: img9 },
  ];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                ...
                <span className="text-xs font-medium text-stone-600">E-Commerce Platform</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                E-Shopping <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Store</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A fully functional e-commerce website with product listings, shopping cart, 
                and checkout functionality. Features include product filtering, cart management, 
                order summary, and responsive design for seamless shopping across all devices.
              </p>
