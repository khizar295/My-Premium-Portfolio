...
import img1 from "../../assets/slider-proj-2-1.png";
import img2 from "../../assets/slider-proj-2-2.png";
import img3 from "../../assets/slider-proj-2-3.png";
import img4 from "../../assets/slider-proj-2-4.png";
import img5 from "../../assets/slider-proj-2-5.png";
import img6 from "../../assets/slider-proj-2-6.png";
import img7 from "../../assets/slider-proj-2-7.png";
import img8 from "../../assets/slider-proj-2-8.png";
import img9 from "../../assets/slider-proj-2-9.png";
import img10 from "../../assets/slider-proj-2-10.png";

export default function Project2() {
  const redirectUrl = "https://khizar-system.vercel.app/";
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <span className="text-xs font-medium text-stone-600">Systems Limited Clone</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Systems Limited <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Website Clone</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A complete replica of one of Pakistan's top software houses, Systems Limited. 
                This project showcases modern front-end development with responsive design, 
                smooth animations, and pixel-perfect implementation of the original design.
              </p>
