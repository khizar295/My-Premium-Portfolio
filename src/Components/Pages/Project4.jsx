...
import img1 from "../../assets/slider-proj-4-1.png";
import img2 from "../../assets/slider-proj-4-2.png";
import img3 from "../../assets/slider-proj-4-3.png";
import img4 from "../../assets/slider-proj-4-4.png";
import img5 from "../../assets/slider-proj-4-5.png";
import img6 from "../../assets/slider-proj-4-6.png";
import img7 from "../../assets/slider-proj-4-7.png";
import img8 from "../../assets/slider-proj-4-8.png";
import img9 from "../../assets/slider-proj-4-9.png";
import img10 from "../../assets/slider-proj-4-10.png";
import img11 from "../../assets/slider-proj-4-11.png";
import img12 from "../../assets/slider-proj-4-12.png";
import img13 from "../../assets/slider-proj-4-13.png";

export default function Project4() {
  const redirectUrl = "https://khizar-portfolio-2.vercel.app/";
  ...
  const slides = [
    ...
    { id: 13, title: "Project Shot 13", img: img13 },
  ];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <span className="text-xs font-medium text-stone-600">Creative Portfolio</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                Modern <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Portfolio Theme</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A fresh and creative portfolio theme designed to showcase skills and projects 
                in an elegant way. Built with HTML, CSS, JavaScript, and Bootstrap, featuring 
                responsive design, smooth animations, and a professional layout.
              </p>
