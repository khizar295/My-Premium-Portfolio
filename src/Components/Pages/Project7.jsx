...
import { FaExternalLinkAlt, FaShieldAlt, FaSpinner, FaCheckCircle, FaTruck } from "react-icons/fa";
import img1 from "../../assets/slider-proj-7-1.png";
import img2 from "../../assets/slider-proj-7-2.png";
import img3 from "../../assets/slider-proj-7-3.png";
import img4 from "../../assets/slider-proj-7-4.png";
import img5 from "../../assets/slider-proj-7-5.png";
import img6 from "../../assets/slider-proj-7-6.png";
import img7 from "../../assets/slider-proj-7-7.png";
import img8 from "../../assets/slider-proj-7-8.png";
import img9 from "../../assets/slider-proj-7-9.png";

export default function Project7() {
  const redirectUrl = "https://khizar-courier-service-kcs.vercel.app/";
  ...
  const slides = [
    { id: 1, title: "Home Page", img: img1 },
    { id: 2, title: "Tracking", img: img2 },
    { id: 3, title: "Services", img: img3 },
    { id: 4, title: "Pricing", img: img4 },
    { id: 5, title: "Delivery Zones", img: img5 },
    { id: 6, title: "Schedule Pickup", img: img6 },
    { id: 7, title: "Order Status", img: img7 },
    { id: 8, title: "Contact Support", img: img8 },
    { id: 9, title: "Mobile View", img: img9 },
  ];
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl p-6 md:p-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-100 to-rose-100 mb-5">
                <FaTruck className="text-amber-600 text-xs" />
                <span className="text-xs font-medium text-stone-600">Logistics Platform</span>
              </div>
              
              <h1 className="font-display text-3xl md:text-4xl font-bold text-stone-800 mb-4">
                KCS Courier <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-500">Service</span>
              </h1>
              
              <p className="text-stone-600 leading-relaxed mb-6">
                A comprehensive logistics and courier service website with tracking and delivery options. 
                Features include real-time package tracking, delivery zone mapping, price calculator, 
                pickup scheduling, and order status management. Built with React.js for seamless user experience.
              </p>
